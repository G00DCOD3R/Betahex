...
{
	strat w;
	w.a = cur.a + random(max(-cur.a, -20), min(100 - cur.a, 20));
	w.b = cur.b + random(max(-cur.b, -20), min(100 - cur.b, 20));
...
player me, they;
ld TIME_PER_MOVE = 10.0; // time that ai will take to choose a move
